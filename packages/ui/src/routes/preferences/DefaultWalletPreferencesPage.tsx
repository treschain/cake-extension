            ...
            <div className="flex flex-col p-6 space-y-6 w-full">
                <div className="text-sm text-gray-500">
                    {wasDefaultBrowserWallet ? (
                        <span>
                            TresWallet is set as your default browser wallet.
                        </span>
                    ) : (
                        <span>
                            TresWallet is not set as your default browser
                            wallet.
                        </span>
                    )}
                </div>
                ...
                <div className="text-sm text-gray-500">
                    {wasDefaultBrowserWallet ? (
                        <span>
                            Turning this off will make TresWallet unable to
                        ...
                        <span>
                            Turning this on will make TresWallet connect to
                            DApps by default. Turn it on if you want to use
                            TresWallet to connect to DApps, instead of other
                            browser wallets.
                        </span>
                    )}
                    <br />
