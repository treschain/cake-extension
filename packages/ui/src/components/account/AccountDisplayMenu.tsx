        ...
        case AccountMenuOptionType.REMOVE_ACCOUNT: {
            return {
                ...
                confirmationMessage: isHardwareWallet(account.accountType)
                    ? "Removing an external account deletes all connected data from TresWallet. You can re-connect your hardware wallet account at any time. Are you sure you want to remove this hardware wallet account?"
                    : "Removing an external account deletes all connected data from TresWallet. You can re-add your external account at any time using your private key. Are you sure you want to remove this external account?",
            }
        }
    }
